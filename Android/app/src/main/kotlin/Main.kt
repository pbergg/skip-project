...
internal val logger: SkipLogger = SkipLogger(subsystem = "skip.project", category = "SkipProject")

private typealias AppRootView = SkipProjectRootView
private typealias AppDelegate = SkipProjectAppDelegate
